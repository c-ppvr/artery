...
public class ArteryScreenHandlerTypes {
    ...
    public static final ScreenHandlerType<FibroblasterScreenHandler> FIBROBLASTER_SCREEN_HANDLER = register("fibroblaster", ((syncId, playerInventory) -> new FibroblasterScreenHandler(syncId, playerInventory, new SimpleInventory(1), new ArrayPropertyDelegate(2))));
